...
from torchsparse_20.nn.utils import get_kernel_offsets
...
def build_kernel_map(_coords: torch.Tensor,
    ...
    if mode == 'grid':
        ...
        if subm:
            func = torchsparse_20.backend.build_kernel_map_subm
        else:
            func = torchsparse_20.backend.build_kernel_map_downsample
        out = func(coords,
                   coords.min(0).values,
        ...
        input_mask, output_mask = torchsparse_20.backend.build_mask_from_kmap(
